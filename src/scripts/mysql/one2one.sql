...
join information_schema.KEY_COLUMN_USAGE kcu on kcu.CONSTRAINT_NAME=rc.CONSTRAINT_NAME and kcu.TABLE_NAME=rc.TABLE_NAME and kcu.TABLE_SCHEMA=rc.CONSTRAINT_SCHEMA and kcu.TABLE_SCHEMA='{db}'
union
select kcu.REFERENCED_TABLE_NAME AS TABLE_NAME, kcu.REFERENCED_COLUMN_NAME AS COLUMN_NAME, rc.TABLE_NAME AS REFERENCED_TABLE_NAME, kcu.COLUMN_NAME AS REFERENCED_COLUMN_NAME
from information_schema.REFERENTIAL_CONSTRAINTS rc
...
join information_schema.KEY_COLUMN_USAGE cu on kcu.COLUMN_NAME =cu.COLUMN_NAME and kcu.TABLE_NAME=cu.TABLE_NAME and kcu.TABLE_SCHEMA=cu.CONSTRAINT_SCHEMA
