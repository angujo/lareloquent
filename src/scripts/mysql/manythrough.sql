select
    ...
    ft.COLUMN_NAME AS THROUGH_REF_COLUMN_NAME,
    ft.REFERENCED_TABLE_NAME,
    ft.REFERENCED_COLUMN_NAME
from information_schema.REFERENTIAL_CONSTRAINTS rc
     ...
     )	ft on ft.CONSTRAINT_SCHEMA=rc.CONSTRAINT_SCHEMA and ft.TABLE_NAME=kcu.TABLE_NAME
