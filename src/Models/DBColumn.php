...
class DBColumn extends DBInterface
{
    ...
    public function getValidation(): array
    {
        ...
        $raw_valids = array_values(array_map(function ($v) {
        ...
        return $this->_validation = array_filter($raw_valids, function ($k) {
            return array_key_exists(strtolower($k), BaseRequest::$default_messages);
     ...
     * @throws \Exception
     */
    public function getEnum(): ?DBEnum
    {
    ...
    public function PhpDataType(): DataType
    {
    ...
    public function tsDataType(): TSType
    {
    ...
    protected function getTypeId(): DataType
    {
    ...
    public function maxValue()
    {
        ...
        return DataType::STRING == $this->PhpDataType() ?
            ...
            floatval("1" . implode('', array_map(function ($v) {
                    return "0";
                }, range(1, $this->character_maximum_length - $this->numeric_scale)))) - 1;
    }
}