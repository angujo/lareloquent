    ...
    private function accessName()
    {
        switch ($this->ref) {
            ...
            case Referential::MANYTHROUGH:
                return implode('_', [in_singular(str_equal(col_name_reference($this->through_column_name), $this->table_name) ? $this->fromColumnName(true) : col_name_reference($this->through_ref_column_name)), in_plural($this->referenced_table_name)]);
